...
Explore Scotch-Irish cultural heritage through the McCreary family lens. Covers language (Scottish Gaelic, Scots, English), music, foodways, religious practices, crafts, folklore, and how traditions evolved across migrations. Shows how families maintained cultural identity while adapting to new environments.

**Key Topics**: Scotch-Irish culture, language evolution, traditional music, food and agriculture, crafts, folklore, cultural adaptation
...
- **Start with [Introduction](01-introduction/index.md)** if you're new to McCreary family history
- **Go to [Genealogy](02-family-history-and-genealogy/index.md)** if you're researching your family tree
- **Explore the [Timeline](03-timeline/index.md)** to understand historical chronology
- **View [Interactive Maps](../sims/maps/migration/index.html)** to visualize migration patterns
- **Read [Religion](06-religion/index.md)** to understand Presbyterian heritage
- **Use [Educational Resources](05-education/index.md)** if you're teaching this material
